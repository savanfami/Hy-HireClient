...
export const SingupCompany = () => {
  ...
  const [userType, setUserType] = useState<string | undefined>(location.state?.userType || 'company');
        ...
        <div className='flex items-center justify-center font-sans '>
          {otpPage ? (<OtpPage onBackToSignup={handleBackToSignup} />) : (
            <div className='w-full max-w-md p-8 bg-white '>
              <h2 className='text-3xl font-bold font-gg  text-center mb-1'>Company Sign Up</h2>
              ...
              <Formik initialValues={initialValues} validationSchema={CompanySignupValidationSchema()} onSubmit={handleSubmit} >
                  <>
                    <Form className='space-y-2' >
                      <div>
                        <label htmlFor="email" className='block mt-2 mb-1 font-medium'>Email</label>
                        <Field type="email" name='email' id="email" className='w-full px-3 py-2 border rounded-md' placeholder='Enter Company email' />
                      ...
                      <div>
                        ...
                        <Field type="text" name='name' id="name" className='w-full px-3 py-2 border rounded-md' placeholder= 'enter Company Name' />
                      ...
                      <button type="submit" className='w-full py-2 px-4 bg-maincolr mt-4 text-white rounded-3xl '>
                        {loading ? (
