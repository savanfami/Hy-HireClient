...
import { MessagePrivateRoute, UserPrivateRoute } from './components/user/UserPrivateRoute'
...
import { VideoCallProtectedRoute } from './components/common/VideoCallProtectionRoute';
import  ScheduledInterviews  from './pages/user/ScheduledInterviews';
import { JobApplicationDetails } from './pages/user/JobApplicationDetails';
    ...
    <ErrorBoundary>
      <Routes>
        ...
        <Route path='profile' element={
          ...
          <Route path='applications/:id' element={<JobApplicationDetails />}/>
          <Route path='schedule' element={<ScheduledInterviews/>}/>
        </Route>
